...
public class DoomfulJEIPlugin implements IModPlugin
{
    ...
    public void registerRuntime(IRuntimeRegistration registration)
    {
        ...
        List<SmithingRecipe> recipes = recipeManager.getAllRecipesFor(RecipeType.SMITHING).stream().filter(recipe -> recipe.getId().getNamespace().equals(Doomful.ID)).toList();
