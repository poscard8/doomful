...
public class DoomfulConfig
{
    ...
    public static boolean isSmiteEnabled() { return ENABLE_SMITE.get(); }

    public static boolean isBaneOfArthropodsEnabled() { return ENABLE_BANE_OF_ARTHROPODS.get(); }

    public static boolean isImpalingEnabled() { return ENABLE_IMPALING.get(); }
    ...
    static
    {
        ...
        ATROCIOUS_RELIC_CHANCE = BUILDER
                .comment("The chance of getting an Atrocious Relic from a Blaze")
        ...
        ENABLE_SMITE = BUILDER
                .comment("Doomful mod disables Smite, Bane of Arthropods, and Impaling enchantments since they are replaced with a new mechanic")
                .comment("Disabled enchantments have no effect and are unobtainable in survival mode")
                .comment("If true, these enchantments will be re-enabled")
                .define("enableSmite", false);
